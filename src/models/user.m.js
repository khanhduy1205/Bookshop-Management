...
module.exports = {
    ...
    add: async (acc) => {
        const result = await db.one(
            'INSERT INTO "Accounts"("accountID", username, fullname, password, address, email, phone) VALUES($1, $2, $3, $4, $5, $6, $7) RETURNING *',
    ...
    editPassword: async (pw, id) => {
        const result = await db.none('UPDATE "Accounts" SET "password"=$1 WHERE "accountID"=$2', [pw, id]);
        return result;
    },
    editAccount: async (acc) => {
        const result = await db.none(
            'UPDATE "Accounts" SET "fullname"=$1, "phone"=$2, "email"=$3, "address"=$4 WHERE "username"=$5',
